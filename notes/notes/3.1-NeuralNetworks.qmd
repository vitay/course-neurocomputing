...
![Multi-layer perceptron with one hidden layer.](../slides/img/mlp.svg){width=70%}
...
![Fully-connected layer.](../slides/img/matrixvector.png)
...
![Some classical activation functions in MLPs.](../slides/img/ratecoded-transferfunctions.png)
...
![ReLU vs. PReLU activation functions.](../slides/img/prelu.ppm)
