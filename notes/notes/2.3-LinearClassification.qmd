...
![Example of **One-vs-All** classification: one binary classifier per class. Source <http://cs231n.github.io/linear-classify>](../slides/img/pixelspace.jpg){width=80%}
...
![Linear perceptron for images. The output is the logit score. Source <http://cs231n.github.io/linear-classify>](../slides/img/imagemap.jpg){width=100%}
...
![The logit scores $\mathbf{z}$ cannot be compared to the targets $\mathbf{t}$: we need to transform them into a probability distribution $\mathbf{y}$.](../slides/img/softmax-transformation.png){width=100%}
...
![Softmax linear classifier](../slides/img/softmaxclassifier.svg){width=60%}
