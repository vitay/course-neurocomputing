...
![Visualization of least mean squares applied to a simple regression problem with $\eta=0.1$. Each step of the animation corresponds to one epoch (iteration over the training set).](../slides/img/regression-animation.gif){width=70%}
...
![Evolution of the loss function during training.](../slides/img/regression-animation-loss.png){width=70%}
...
![Visualization of the delta learning rule applied to a simple regression problem with $\eta = 0.1$. Each step of the animation corresponds to one epoch (iteration over the training set).](../slides/img/regression-animation-online.gif){width=70%}

![Evolution of the loss function during training. With the same learning rate, the delta learning rule converges much faster but reaches a poorer minimum. Lowering the learning rate slows down learning but reaches a better minimum.](../slides/img/regression-animation-online-loss.png){width=70%}
...
![CO2 emissions and fuel consumption depend almost linearly on the engine size and number of cylinders.](../slides/img/MLR-example-data.png){width=90%}

![CO2 emissions and fuel consumption depend almost linearly on the engine size and number of cylinders.](../slides/img/MLR-example-data-3d.png){width=100%}
...
![Polynomial regression.](../slides/img/polynomialregression.png){width=60%}
...
![Linear data with one outlier.](../slides/img/regression-outlier.png){width=70%}

LMS would find the minimum of the mse, but it is clearly a bad fit for most points.

![LMS is attracted by the outlier, leading to a bad prediction for all points.](../slides/img/regression-outlier-fit.png){width=70%}

This model feels much better, but its residual mse is actually higher...

![By ignoring the outlier, the prediction would be correct for most points. ](../slides/img/regression-outlier-fit-corrected.png){width=70%}

Let's visualize polynomial regression with various orders of the polynomial on a small dataset.


![Polynomial regression with various orders.](../slides/img/polynomialregression-animation.gif){width=70%}
...
![Residual mse of polynomial regression depending on the order of the polynomial.](../slides/img/polynomialregression-mse.png){width=70%}
...
![Polynomial data split in a training set and a test set.](../slides/img/polynomialregression-traintest.png){width=70%}
...
![k-fold cross-validation. Source <https://upload.wikimedia.org/wikipedia/commons/1/1c/K-fold_cross_validation_EN.jpg>](../slides/img/kfold.jpg){width=70%}
...
![Training and test mse of polynomial regression.](../slides/img/polynomialregression-mse-traintest.png){width=90%}
...
![Underfitting and overfitting.](../slides/img/underfitting-overfitting.png){width=100%}
...
![Bias and variance of an estimator. Source: <http://scott.fortmann-roe.com/docs/BiasVariance.html>](../slides/img/biasvariance3.png){width=80%}
...
![The optimal complexity of an algorithm is a trade-off between bias and variance. Source: <http://scott.fortmann-roe.com/docs/BiasVariance.html>](../slides/img/biasvariance2.png){width=80%}
...
![Linear regression underfits non-linear data.](../slides/img/underfitting-overfitting-linear.png){width=60%}

![Linear regression overfits outliers.](../slides/img/regression-outlier-fit.png){width=60%}
...
![Ridge regression finds the smallest value for the weights that minimize the mse. Source: <https://www.mlalgorithms.org/articles/l1-l2-regression/>](../slides/img/ridge-effect.png){width=60%}
...
![LASSO regression tries to set as many weight to 0 as possible (sparse code). Source: <https://www.mlalgorithms.org/articles/l1-l2-regression/>](../slides/img/lasso-effect.png){width=60%}
...
![Linear regression tends to assign values to all weights. Source: <https://www.analyticsvidhya.com/blog/2017/06/a-comprehensive-guide-for-linear-ridge-and-lasso-regression/>](../slides/img/linearregression-withoutregularization.png){width=80%}

![LASSO regression tries to set as many weights to 0 as possible (sparse code). Source: <https://www.analyticsvidhya.com/blog/2017/06/a-comprehensive-guide-for-linear-ridge-and-lasso-regression/>](../slides/img/linearregression-withregularization.png){width=80%}
