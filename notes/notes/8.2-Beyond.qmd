...
![The credit assignment problem. Source: <https://simons.berkeley.edu/sites/default/files/docs/9574/backpropagationanddeeplearninginthebrain-timothylillicrap.pdf>](../slides/img/creditassignment1.png)
...
![Source: <https://simons.berkeley.edu/sites/default/files/docs/9574/backpropagationanddeeplearninginthebrain-timothylillicrap.pdf>](../slides/img/creditassignment2.png){width=80%}
...
![Source: <https://en.wikipedia.org/wiki/Neuron>](../slides/img/chemicalsynapse.jpg){width=80%}
...
![Source: @Lillicrap2016](../slides/img/feedbackalignment1.png)

![Source: @Lillicrap2016](../slides/img/feedbackalignment2.png)
...
![Source: @Lillicrap2016](../slides/img/feedbackalignment3.png)
...
![Source: <https://doi.org/10.1038/s41593-018-0200-7>](../slides/img/predictivecoding.png)
...
![Source: <https://www.frontiersin.org/articles/10.3389/frobt.2018.00021>](../slides/img/activeinference2.jpg)
...
![Felleman, D. J., and Van Essen, D. C. (1991). Distributed hierarchical processing in the primate cerebral cortex. Cereb. Cortex 1, 1–47. doi:10.1093/cercor/1.1.1.](../slides/img/fellemanvanessen.png)
...
The figure above is only for vision, and only for the cerebral cortex: the thalamus, basal ganglia, hippocampus, cerebellum, etc, create additional shortcuts.
...
![](../slides/img/ratecoded-izhikevich.png)
...
![Tanaka et al. (2019). Recent advances in physical reservoir computing: A review. Neural Networks 115, 100–123. doi:10.1016/j.neunet.2019.03.005.](../slides/img/RC-principle2.png)
...
![](../slides/img/reservoir-dynamics-reproduce2.png)
...
![](../slides/img/reservoir-dynamics-chaos.png)
...
![Seoane, L. F. (2019). Evolutionary aspects of reservoir computing. Philosophical Transactions of the Royal Society B. doi:10.1098/rstb.2018.0377.](../slides/img/rc-patternseparation.png){width=70%}
...
![Source: <https://towardsdatascience.com/predicting-stock-prices-with-echo-state-networks-f910809d23d4>](../slides/img/rc-forecasting.png)
...
![Pathak et al. (2018). Model-Free Prediction of Large Spatiotemporally Chaotic Systems from Data: A Reservoir Computing Approach. Physical Review Letters 120, 024102–024102. doi:10.1103/PhysRevLett.120.024102.](../slides/img/rc-flame.gif)
...
![Tanaka et al. (2018). Recent Advances in Physical Reservoir Computing: A Review. arXiv:1808.04962](../slides/img/rc-memristor.jpg)
...
![Fernando, C., and Sojakka, S. (2003). Pattern Recognition in a Bucket. doi:10.1007/978-3-540-39432-7_63.](../slides/img/liquidbrain.png)

![Fernando, C., and Sojakka, S. (2003). Pattern Recognition in a Bucket. doi:10.1007/978-3-540-39432-7_63.](../slides/img/liquidbrain2.png)

Real biological neurons can be kept alive in a culture and stimulated /recorded to implement a reservoir.

![Frega et al. (2014). Network dynamics of 3D engineered neuronal cultures: a new experimental model for in-vitro electrophysiology. Scientific Reports 4, 1–14. doi:10.1038/srep05489.](../slides/img/rc-culture2.jpg)
...
![Jones, B., Stekel, D., Rowe, J., and Fernando, C. (2007). Is there a Liquid State Machine in the Bacterium Escherichia Coli? doi:10.1109/ALIFE.2007.367795.](../slides/img/rc-ecoli.png)
...
![Rossant et al. (2011). Fitting Neuron Models to Spike Trains. Front. Neurosci. 5. doi:10.3389/fnins.2011.00009](../slides/img/spiketrain.jpg)
...
![Bi, G. and Poo, M. (2001). Synaptic modification of correlated activity: Hebb's postulate revisited. Ann. Rev. Neurosci., 24:139-166.](../slides/img/stdp.jpg){width=70%}
...
![Bi, G. and Poo, M. (2001). Synaptic modification of correlated activity: Hebb's postulate revisited. Ann. Rev. Neurosci., 24:139-166.](../slides/img/stdp2.png)
...
![Kheradpisheh et al. (2018). STDP-based spiking deep convolutional neural networks for object recognition. Neural Networks 99, 56–67. doi:10.1016/j.neunet.2017.12.005.](../slides/img/masquelier-architecture.png)
...
![Kheradpisheh et al. (2018). STDP-based spiking deep convolutional neural networks for object recognition. Neural Networks 99, 56–67. doi:10.1016/j.neunet.2017.12.005.](../slides/img/masquelier2.png){width=80%}
...
![Kheradpisheh et al. (2018). STDP-based spiking deep convolutional neural networks for object recognition. Neural Networks 99, 56–67. doi:10.1016/j.neunet.2017.12.005.](../slides/img/masquelier3.png){width=80%}

The performance on MNIST is in line with classical 3-layered CNNs, but without backpropagation!

![Kheradpisheh et al. (2018). STDP-based spiking deep convolutional neural networks for object recognition. Neural Networks 99, 56–67. doi:10.1016/j.neunet.2017.12.005.](../slides/img/masquelier4.png)
...
![Source: <https://www.researchgate.net/publication/280600732_A_Computational_Model_of_Innate_Directional_Selectivity_Refined_by_Visual_Experience>](../slides/img/eventbased-spike.jpg)
...
![Source: <https://en.wikichip.org/wiki/intel/loihi>](../slides/img/lohihi-overview.png)
...
![Source: <https://en.wikichip.org/wiki/intel/loihi>](../slides/img/loihi_core.png)


![Source: <https://en.wikichip.org/wiki/intel/loihi>](../slides/img/loihi_spikes.gif)
...
![Source: <https://en.wikichip.org/wiki/intel/loihi>](../slides/img/loihi-algos.png)
...
![Source: <https://fuse.wikichip.org/news/2519/intel-labs-builds-a-neuromorphic-system-with-64-to-768-loihi-chips-8-million-to-100-million-neurons/>](../slides/img/loihi-comp.png)
...
![Conway's game of life. Source: <https://www.jakubkonka.com/2015/03/15/game-of-life.html>](../slides/img/gameoflife2.gif)
