...
![Source: <https://towardsdatascience.com/map-mean-average-precision-might-confuse-you-5956f1bfa9e2>](../slides/img/mAP-basic.png)
...
![Source: <https://towardsdatascience.com/map-mean-average-precision-might-confuse-you-5956f1bfa9e2>](../slides/img/mAP-basic2.webp)
...
![Source: <https://towardsdatascience.com/map-mean-average-precision-might-confuse-you-5956f1bfa9e2>](../slides/img/mAP-basic3.webp)

Let's now compute the **precision-recall curve** over 7 images, with 15 ground truth boxes and 24 predictions.

![Source: <https://github.com/rafaelpadilla/Object-Detection-Metrics>](../slides/img/meanAP-1.png)

Each prediction has a confidence score for the classification, and is either a TP or FP (depending on the IoU threshold).


![Source: <https://github.com/rafaelpadilla/Object-Detection-Metrics>](../slides/img/meanAP-2.png)
...
![Source: <https://github.com/rafaelpadilla/Object-Detection-Metrics>](../slides/img/meanAP-3.png)

If we plot the **precision x recall curve** (PR curve) for the 24 predictions, we obtain:

![Source: <https://github.com/rafaelpadilla/Object-Detection-Metrics>](../slides/img/meanAP-4.png)
...
![Source: <https://github.com/rafaelpadilla/Object-Detection-Metrics>](../slides/img/meanAP-5.png)


![Source: <https://github.com/rafaelpadilla/Object-Detection-Metrics>](../slides/img/meanAP-6.png)
...
![Source: @VanEtten2019.](../slides/img/mAP-ssd.webp)
