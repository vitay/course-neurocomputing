...
![Confusion matrix.](../slides/img/confusionmatrix.png){width=50%}
...
![Training, validation and test sets. Source: <https://developers.google.com/machine-learning/crash-course/validation/another-partition>](../slides/img/validationset.svg){width=80%}
...
![A linear classifier in 2D can classify any configuration of three points.](../slides/img/vc4.png){width=60%}
...
![There exists configurations of four points in 2D that cannot be linearly classified.](../slides/img/vc6.png){width=60%}
...
![Structural risk minimization.](../slides/img/srm.png){width=60%}
...
![Projection to a feature space.](../slides/img/featurespace.png){width=60%}
...
![Radial basis function network. Source: <https://mccormickml.com/2013/08/15/radial-basis-function-network-rbfn-tutorial/>](../slides/img/rbf.png){width=80%}
...
![RBF networks learn linearly smooth transitions between the training examples. Source: <https://mccormickml.com/2013/08/15/radial-basis-function-network-rbfn-tutorial/>](../slides/img/rbf3.png){width=80%}
...
![Support-vectors are the closest examples to the hyperplane. They have a non-zero $\alpha$ coefficient.](../slides/img/supportvectors.svg){width=60%}
