...
::: {.callout-note}
In the B202 (FRIZ), conda is already installed. All you need to do is to once type these commands in a terminal:
...
The last line can wait until the corresponding exercise.
