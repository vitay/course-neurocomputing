...
![](img/encoder_with_tensors_2.png){width=65%}
...
![](img/transformer_attention_heads_weight_matrix_o.png){width=80%}
...
![](img/bert-classifier.png){width=70%}
...
![](img/vision-transformer.gif){width=60%}
