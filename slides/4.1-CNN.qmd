...
![Source: <https://github.com/vdumoulin/conv_arithmetic>](img/same_padding_no_strides.gif){width=70%}
...
![Source: <https://cloud.google.com/tpu/docs/inception-v3-advanced>](img/inceptionv3.png){width=80%}
